...
const CartItem = ({ id, image, name, color, price, amount }: { id: string; image: string; name: string; color: string; price: number; amount: number }) => {
	const { removeItem, toggleAmount } = useCartContext() as CartContextType;
