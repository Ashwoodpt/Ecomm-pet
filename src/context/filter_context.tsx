...
import { ProductContextType, FilterContextType, FilterSortType } from '../utils/types';
...
export const FilterProvider = ({ children }: { children: React.ReactNode }) => {
	const { products } = useProductsContext() as ProductContextType;
	...
	const updateSort = (e: React.ChangeEvent<HTMLSelectElement>) => {
		const value = e.target.value as FilterSortType;
